...
<html lang="en">
    <head>
        ...
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    </head>
    <body>
        ...
        <div class="col-left">
            ...
            if(isset($_GET['category_id'])){
                ...
                $post_query_count = "SELECT * FROM posts WHERE post_category_id = $category_id AND post_status = 'published'";
                ...
                $query .= "WHERE post_category_id = $category_id AND post_status = 'published' ORDER BY post_date DESC LIMIT $page_1 , 5";
            ...
            <!--End of main if condition, If no post found in category pager will not be shown-->
            <?php }
                else{
            ...
            $(function () {
                    ...
                    getPageRange(totalPages, currentPage, paginationSize).forEach( item => {
                        $("<li>").addClass("page-item")
                            ...
                            $("<a>").addClass("page-link").attr({
                                href: "category.php?category_id=" + <?php echo $category_id;?> + "&page=" + item}).text(item)
                ...
                $(".pagination").append(
                    $("<li>").addClass("page-item").attr({ id: "previous-page" }).append(
                        $("<a>").addClass("page-link").attr({
                            href: "category.php?category_id=" + <?php echo $category_id;?> + "&page=" + (currentPage -1)}).text("Prev")
                    ),
                    $("<li>").addClass("page-item").attr({ id: "next-page" }).append(
                        $("<a>").addClass("page-link").attr({
                            href: "category.php?category_id=" + <?php echo $category_id;?> + "&page=" + (currentPage +1)}).text("Next")
                    )
                );
                // Show the page links
